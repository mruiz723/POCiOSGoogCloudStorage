...
final class AuthenticationViewModel: ObservableObject {
	...
	var hasDriveScope: Bool {
		return authorizedScopes.contains(GoogleDriveService.driveScope)
	}

	/// Adds the requested Google Drive scope.
	...
	func addGoogleDriveScope(completion: @escaping () -> Void) {
		authenticator.addGoogleDriveScope(completion: completion)
	}
